...
Console.WriteLine("Программа задаёт две матрицы и находит их произведение!");
...
int[,] GetArray(int m, int n, int min, int max)                                   // функция создает матрицу, заполненную рандомом
{
...
void PrintArray(int[,] inArray)                                                   // функция выводит матрицу в консоль
{
...
int[,] GetMultiplicationMatrix(int[,] arrayA, int[,] arrayB)                      // функция считает произведение 2-х матриц
{
